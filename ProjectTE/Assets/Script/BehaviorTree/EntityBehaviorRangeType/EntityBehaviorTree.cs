...
{
    public class EntityBehaviorRangeType : EntityBehaviorTreeBase , IBehaviorTreeSetter
    {
        public EntityBehaviorRangeType(string _name, int _uniqueID, EntityContoller _controller) : base(_name, _uniqueID,_controller) {
            AISetup();
        }
