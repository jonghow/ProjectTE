...
{
    public class EntityBehaviorRogueType : EntityBehaviorTreeBase , IBehaviorTreeSetter
    {
        public EntityBehaviorRogueType(string _name, int _uniqueID, EntityContoller _controller) : base(_name, _uniqueID,_controller) {
            AISetup();
        }
